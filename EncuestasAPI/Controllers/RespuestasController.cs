...
namespace EncuestasAPI.Controllers
{
	...
	public class RespuestasController : ControllerBase
	{
		...
		public RespuestasController(IMapper mapper, Repository<Encuestadetalle> repoDetalles,
			Repository<Respuesta> _respuestasRepository, IHubContext<EstadisticasHub> hub,
		...
		public Repository<Encuestadetalle> RepoDetalles { get; }
		public Repository<Respuesta> RespuestasRepository { get; }
		...
		public IActionResult GetAll()
		{
			var respuestas = RespuestasRepository.GetAll()
				.Select(r => new
				{
					...
					r.NumControlAlumno,
					r.FechaAplicacion,
					Respuestas = r.Encuestadetalle.Select(d => new
					{
						d.IdPregunta,
						d.ValorEvaluacion
					})
		...
		public async Task <IActionResult> RegistrarInicio([FromBody] RespuestaDTO dto)
		{
			...
			var entidad = Mapper.Map<Respuesta>(dto);
		...
		public async Task <IActionResult> ResponderPreguntas([FromBody] List<RespuestaDetalleDTO> dtos)
		{
			...
			{
				var detalleRespuesta = new Encuestadetalle
				{
