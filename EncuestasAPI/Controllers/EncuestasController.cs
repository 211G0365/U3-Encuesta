...
namespace EncuestasAPI.Controllers
{
	...
	public class EncuestasController : ControllerBase
	{
		...
		private readonly Repository<Encuesta> _encuestaRepo;
		private readonly Repository<Pregunta> _preguntaRepo;
		private readonly Repository<Respuesta> _respuestasRepo;
		...
		public EncuestasController(Repository<Encuesta> encuestaRepo,
		Repository<Pregunta> preguntaRepo, Repository<Respuesta> respuestasRepo,
		...
		public async Task<IActionResult> CreateEncuesta([FromBody] CrearEncuestaDTO dto)
		{
			if (Validador.Validate(dto, out List<string> errores))
			{
				...
				var encuesta = new Encuesta
				{
					...
					Pregunta = dto.Preguntas.Select(P => new Pregunta
					{
